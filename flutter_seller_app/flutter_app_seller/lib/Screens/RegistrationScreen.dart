...
import 'package:flutterappseller/Screens/afterregistration.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar:  AppBar(
          ...
          centerTitle: true,
          backgroundColor: Color(0xFFF4F0E7),
          title: Text('Only a Few Details 🤝',style:TextStyle(color: Color(0xFF0DA9E4),fontSize: 24) ,),
        ),
                ...
                decoration: InputDecoration(
                  focusedBorder:OutlineInputBorder(
                   ...
                   //focusColor: Color(0xFFFFD6B0),
                    ...
                    hintText: 'Enter Your Shops Name Here',
                    labelText: 'Shop Name'
                ),
              ),
            ),
            ...
            Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    hintText: 'The Police Station nearest to your shop',
...
//              if(_formKey.currentState.validate()){
                ...
                Navigator.popAndPushNamed(context, inter.id);
//              }
//              print('$name'
